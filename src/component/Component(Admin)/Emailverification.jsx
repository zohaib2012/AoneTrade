...
const EmailVerification = () => {
    const [sendCode,{isError,isLoading,error,isSuccess}]=useSendCodeMutation()
  ...
  return (
    <div className="bg-[#23282B] min-h-screen flex items-center justify-center p-4">
      ...
      >
        ...
        <h2 className="text-white text-2xl font-semibold text-center py-4">Email verification</h2>
