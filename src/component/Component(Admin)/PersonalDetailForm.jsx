...
const PersonalDetailsForm = () => {
  const [Senddetails,{isSuccess, isError,error,isLoading}]=useSenddetailsMutation()
  ...
  return (
    <div className="bg-[#23282B] min-h-screen flex items-center justify-center p-4">
      ...
      >
        ...
        <h2 className="text-white text-2xl font-semibold text-center py-4">Edit Personal Details</h2>
        ...
        <div className="px-4 pb-4">
          ...
          <button 
                type="submit"
                disabled={isLoading}
                className={`${isLoading ? 'bg-gray-500' : 'bg-gray-900 w-full hover:bg-gray-800'} text-white py-3 rounded-lg transition`}
                >
