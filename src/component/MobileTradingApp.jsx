      ...
      <div className="flex w-full max-w-6xl items-center">
        ...
        <div className="w-1/3 ml-28">
          ...
          <p className="text-gray-400 text-sm m-3">
            Scan to Download <br /> FxPro Trading App
          </p>
          <img className='w-32 h-32' src="public/download.png" alt="QR code" />
        </div>
        ...
        <div className="w-1/3 relative z-10">
          ...
          <img src="https://direct-website.azureedge.net/assets/img/svelte-home/platforms/trade-on-mobile-new/trade-on-mobile.webp" alt="" />
        </div>
        </div>
        ...
        <div className="w-1/3 pl-8 text-white">
          ...
          <div className="flex items-center space-x-8">
            ...
            <div>
              ...
              <span className="text-gray-300">More than 15 million downloads</span>
            </div>
          </div>

          {/* Platforms */}
          <div className="mt-4">
            <p className="text-gray-300">Available on iOS and Android devices.</p>
          </div>
        </div>
      </div>
    </div>
